  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-8 bg-slate-100">
      <div className="md:w-1/3 mb-8 md:mb-0">
        <h1 className="text-4xl font-semibold mb-4 lg:pl-28">Why do we help with Legalization</h1>
        <p className="text-lg text-gray-700 lg:pl-28 ">We are here for Thiruvallur to carry out the legalization process, which is sometimes complicated.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:w-2/3 lg:pr-28">
        <div className="bg-white lg:ml-20 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ">
        ...
        <div className="bg-white p-6 lg:mr-20 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="bg-white p-6 lg:ml-20 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
