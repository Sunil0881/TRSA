    ...
    <div>
      ...
      <div className="relative flex justify-between px-5 md:px-10">
        <div className="flex items-center">
          <a href='/'> <img src={logo} width={100} height={100} alt='logo' /></a>
          <a href='/'>
            <h1 className="text-black ml-4 text-md md:text-3xl font-bold">Thiruvallur District Roller <br className="hidden md:block" /> Skating Association.</h1>
          </a>
        </div>
      ...
      <nav className="hidden md:flex items-center md:justify-center font-semibold lg:gap-12 md:gap-2 bg-blue-800 text-white">
        ...
        <Link to="/addevents" className={linkClasses("/addevents")}>Add events</Link>
        <Link to="/addskaters" className={linkClasses("/addskaters")}>Add Skaters</Link>
        <Link to="/message" className={linkClasses("/message")}>Message</Link>
        <Link to="/addimage" className={linkClasses("/addimage")}>Add Gallery</Link>
        <Link to="/admin-add-news" className={linkClasses("/admin-add-news")}>Breaking News</Link>
      </nav>
