    ...
    return (
        <div className="flex flex-col sm:flex-row max-w-7xl w-full bg-white shadow-lg rounded-lg overflow-hidden h-auto sm:h-80 mb-8">
            ...
            <div className="w-full sm:w-3/5 p-4 flex flex-col justify-between">
                ...
                <div className="mt-4 flex flex-row justify-between text-gray-700">
                    <span className="text-sm md:text-xl">Year: <strong>{year}</strong></span>
                    <span className="text-sm md:text-xl">Level: <strong>{level}</strong></span>
                </div>
            </div>
        </div>
    );
