...
const AchievementsCard = ({ image, title, description, year, level }) => {
    return (
        <div className="flex justify-center">
            <div className="flex flex-col sm:flex-row max-w-7xl w-full bg-white shadow-lg rounded-lg overflow-hidden h-auto sm:h-80 mb-8 transition-transform transform hover:scale-105 hover:shadow-2xl">
                <img
                ...
                <div className="w-full sm:w-3/5 p-6 flex flex-col justify-between">
                    <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-600 mt-4 text-base md:text-lg flex-grow">{description}</p>
                    </div>
