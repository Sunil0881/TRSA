...
const GridDesign = () => {
  return (
    ...
    <div className='grid grid-rows-3 grid-cols-3 md:gap-5 lg:gap-10'>
      <div className='flex flex-col justify-center bg-gray-300 md:px-5 md:py-5 lg:px-10 rounded-2xl'>
      ...
      <div className='flex flex-col justify-center md:px-5 px-10 bg-gray-300 rounded-2xl'>
